...
import 'package:admin_panel/features/merchandisers/offers/presentation/widgets/category_selector_dialog.dart';
import 'package:admin_panel/features/merchandisers/offers/presentation/widgets/product_selector_dialog.dart';
import 'package:admin_panel/features/merchandisers/offers/presentation/widgets/sub_category_selector_dialog.dart';
...
class _DiscountOfferFormState extends State<DiscountOfferForm> {
  ...
  Widget _buildDiscountPreview() {
    ...
    final discountText =
        _isPercentage ? '$discountValue% OFF' : 'EGP $discountValue OFF';
  ...
  void _updateDetails() {
    ...
    final details = DiscountOfferDetails(
      ...
      subCategoryId:
          _applicableTo == 'subcategory' ? _selectedSubCategoryId : null,
