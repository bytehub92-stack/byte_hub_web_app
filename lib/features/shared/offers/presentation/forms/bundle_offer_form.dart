...
import 'package:admin_panel/features/shared/offers/presentation/widgets/bundle_item_dialog.dart';
...
class _BundleOfferFormState extends State<BundleOfferForm> {
  ...
  void initState() {
    ...
    if (widget.initialDetails != null) {
      ...
      _bundlePriceController.text = widget.initialDetails!.bundlePrice
          .toString();
    }
  }
  ...
  Widget _buildSavingsPreview() {
    ...
    final savingsPercent = originalTotal > 0
