...
import 'package:admin_panel/features/shared/offers/presentation/pages/create_offer_page.dart';
import 'package:admin_panel/features/shared/offers/presentation/widgets/offer_card.dart';
...
class _OffersManagementPageState extends State<OffersManagementPage> {
  ...
  Widget _buildOffersList(BuildContext context, List<Offer> offers) {
    ...
    final bundleOffers = offers
        .where((o) => o.type == OfferType.bundle)
        .toList();
    final bogoOffers = offers.where((o) => o.type == OfferType.bogo).toList();
    final discountOffers = offers
        .where((o) => o.type == OfferType.discount)
        .toList();
    final minPurchaseOffers = offers
        .where((o) => o.type == OfferType.minPurchase)
        .toList();
    final freeItemOffers = offers
        .where((o) => o.type == OfferType.freeItem)
        .toList();
